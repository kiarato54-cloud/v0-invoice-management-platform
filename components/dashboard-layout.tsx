    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path
          ...
          strokeLinejoin="round"
          strokeWidth={2}
          d="M9 19v-6a2 2 0 010-5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"
        />
      </svg>
    ),
        ...
        <div className="flex h-16 items-center px-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-sidebar-foreground">Huruma Hardware</span>
              <span className="text-xs text-sidebar-foreground/70">Company</span>
            </div>
          </div>
        </div>
